...
export interface AddDocumentProps extends FormComponentProps {
  children: {};
  file?: IdnadrevFile<{}, {}>;
  store: GlobalStore;
  uiStore: UiStore;
...
@observer
class AddDocumentForm extends React.Component<AddDocumentProps, object> {
  @observable file: IdnadrevFile<{}, {}>;
  ...
  componentWillMount() {
    ...
    this.props.uiStore.header = 'Add Document';
  }
