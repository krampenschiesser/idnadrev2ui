...
export class NavigationMenu extends React.Component<NavigationMenuProps, object> {
  render() {
    ...
    let thoughtProcessLink = <Link to='/thought/process'><Icon type='fork'/>Process</Link>;
    ...
    return (
      <Menu
        theme='dark' mode='inline' defaultSelectedKeys={['1']} inlineIndent={24}
