...
var AddTag = /** @class */ (function (_super) {
    ...
    AddTag.prototype.render = function () {
        var _this = this;
        if (this.edit) {
            var autocomplete = <antd_1.AutoComplete dataSource={this.tags} style={{width: 200}}
                                                    onSearch={this.autoComplete} onSelect={function (value) {
                return _this.props.onAdd(value);
            }} placeholder="New Tag"/>;
