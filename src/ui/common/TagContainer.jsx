...
var TagContainer = /** @class */ (function (_super) {
    ...
    function TagContainer() {
        ...
        _this.removeTag = function (tag) {
            _this.fileTags = _this.fileTags.filter(function (e) { return e !== tag; });
            _this.props.item.tags = _this.props.item.tags.filter(function (e) { return e.name !== tag; });
        };
        return _this;
    }
    TagContainer.prototype.componentDidMount = function () {
        this.possibleTags = this.props.store.getTagsStartingWith("");
        this.fileTags = this.props.item.tags.map(function (tag) { return tag.name; });
    };
    TagContainer.prototype.render = function () {
        ...
        {this.fileTags.map(function (e) { return <antd_1.Tag closable onClose={_this.removeTag}>{e}</antd_1.Tag>; })}
      </antd_1.Row>);
    };
    __decorate([
        mobx_1.observable
